...
connection = sql.connect('LabelledData_2_3_4.db')
cursor = connection.cursor()
combined_data.to_sql('data', connection, if_exists='replace', index=False)
data_from_db = pd.read_sql('SELECT * FROM data', connection)
